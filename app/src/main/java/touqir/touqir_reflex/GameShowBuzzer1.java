...
public class GameShowBuzzer1 extends AppCompatActivity {

    private MyNumberPicker numberPicker;
    RelativeLayout relativeLayout;
    MyBasicButton<GameShowBuzzer1> enterButton;
    private int playerNumber;
    private Intent gameShowBuzzer2;
    public final static String numberOfPlayers="touqir.touqir_reflex.GameShowBuzzer1.playerNumber"; //Act as the
    ...
    private void createChildActivity(){
        gameShowBuzzer2= new Intent(this, GameShowBuzzer2.class);
    }
